  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <p>Para imprimir a declaração, acesse o portal do aluno.<br>Para gerar uma nova declaração <a href="https://srv448021.hstgr.cloud/php_api/declaracao">clique aqui</a></p>
      </div>
